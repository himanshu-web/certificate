          ...
          <div class="tile-body">
            <div class="card">
                <div class="card-header text-center text-uppercase">
                  <div class="row">
                    <div class="col-md-6">
                      <label class="float-left" style="padding-top: 12px;"><b><i>List Of Carousel Deatils</i></b></label>
                    </div>
                    <div class="col-md-6">
                      <a href="{{route('c_d_c')}}" style="float: right;color: black;" class="btn btn-sm">Add Carousel</a>
                    </div>
                  </div>
                </div>
                <div class="card-body">
