  ...
  <div >
    <div class="mid-border ">
      <div class="inner-border html_to_pdf">
          <img class="corner-decoration corner-left-top" src="{{ storage_path('app/public/image_left_top1.png') }}"></img>
          <img style="width: 10%;margin-left: 207px;margin-top: 2%;" src="{{ storage_path('app/public/arunachal_pradesh.png') }}"></img>
          <img style="width: 11%;margin-left: 42%;margin-top: -7%;" src="{{ storage_path('app/public/e-office.png') }}"></img>
          <img style="width: 8%;margin-left: 78%;margin-top: -7%;" src="{{ storage_path('app/public/it1.png') }}"></img>
          {{-- <img  src="{{ storage_path('app/public/border4.jpg') }}"></img> --}}
          <img class="corner-decoration corner-right-top" src="{{ storage_path('app/public/image_left_top1.png') }}"></img>
          <img class="corner-decoration corner-right-bottom" src="{{ storage_path('app/public/image_left_top1.png') }}"></img>
          <img class="corner-decoration corner-left-bottom" src="{{ storage_path('app/public/image_left_top1.png') }}"></img>
           <!-- Page Content -->
          <div class="row " >
            <div class="col-lg-12 text-center">
              <h1 style="font-family: sans-serif;" class="html_to_pdf"><center style="color:red;"><b>CERTIFICATE OF TRAINING</b></center></h1>
              <div>
                
                   {{-- {!! QrCode::size(250)->generate('Name:'.$name_of_offician.', Date:'.$date.', Marks:20/20') !!} --}}

              </div>
              <P><center style="font-size: 23px;"><b>This is to certify that</b></center> </P>
              <pre style="font-family: 'Agency FB';font-size: 30px;"><center>Shri.  {{$name_of_offician}}    of        {{$department}}      Department, GoAP</center></pre>
             <hr size="4" width="50%" color="#bdb8b8">
              <P style="font-size: 23px;"><b>has attended the capacity Building Programme on</b></P>
              <h1 style="font-family: sans-serif;"><center style="color:red;"><b>e-Office</b></center></h1>
              ...
              <p style="font-size: 23px;font-family: fangsong;"><b>and is considered <?php if($marks >= 10){ ?><span>PASS</span><?php }else{?><i>FAIL</i><?php } ?> based on the mark scored {{$marks}}/20 Marks in the test. </b></p>
               <div>
                 <img src="{{ storage_path('app/public/image.png') }}" alt="" >
               </div>
            </div>
            <table>
              <tr>
                <td style="width: 16%;"><img src="{{ storage_path('app/public/user_eoffice.jpg') }}" alt="" style="margin-left: 125%;width:44%;"> </td>
